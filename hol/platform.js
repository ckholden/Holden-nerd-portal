  ...
  function renderMobile() {
    document.getElementById("platcontent").innerHTML =
      '<div class="sunken" style="text-align:center;padding:14px 10px">' +
        ...
        '<p class="hint" style="margin-top:8px">There&rsquo;s no phone or tablet app yet. For now, set up Holden On Line on a Windows PC (Mac support is coming soon) &mdash; the buttons above still work if you want to check.</p>' +
      '</div>';
  }
